    ...
    initLoginForm() {
        ...
        form.innerHTML = `
            <div style="text-align: center; padding: 2rem;">
                <button type="button" id="google-signin-btn" class="submit-btn" style="background: #4285f4; display: flex; align-items: center; justify-content: center; gap: 0.5rem; margin: 0 auto;">
